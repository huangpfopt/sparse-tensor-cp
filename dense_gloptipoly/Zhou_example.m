...
lvt = t0; % the relaxation order % when lvt=4, out of memory
...
% try
%     fprintf("----eig extract---\n")
%     [cents, weights,error] = get_atoms_eig(T,n,lvt,Mw,tol);
%     fprintf("cents:\n")
%     disp(cents);
%     fprintf("weights:\n")
%     disp(weights);
...
% 
% try
%     fprintf("----robust extract---\n")
%     [cents, weights,error] = get_atoms_robust(T,n,lvt,Mw,tol);
%     fprintf("cents:\n")
%     disp(cents);
%     fprintf("weights:\n")
%     disp(weights);
